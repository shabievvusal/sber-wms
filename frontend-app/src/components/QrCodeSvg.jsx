// Перенесено вербатим из оригинала (frontend/app/src/components/QrCodeSvg.jsx) —
// самодостаточный генератор QR-кода (версия 4, ECC-блоки, Рид-Соломон) без
// внешних зависимостей, поэтому переносится один в один без изменений.
const VERSION = 4
